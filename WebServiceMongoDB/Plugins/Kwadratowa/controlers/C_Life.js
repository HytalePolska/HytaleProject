...
var Model = require("../models/Life");


function Conditions(data) { return { 'PlayerID': data.PlayerID,'L_date':data.D_date,'L_Healer':data.L_Healer} };
function SetData(data) { return {'PlayerID': data.PlayerID,'L_date':data.D_date,'L_Healer':data.L_Healer,'L_location':data.D_location } } 
var Controller = {};
