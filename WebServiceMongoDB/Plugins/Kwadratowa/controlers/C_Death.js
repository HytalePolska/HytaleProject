...
var Model = require("../models/Death");

function Conditions(data) { return { 'PlayerID': data.PlayerID,'D_date':data.D_date,'D_cause':data.D_cause} };
function SetData(data) { return {'PlayerID': data.PlayerID,'D_date':data.D_date,'D_cause':data.D_cause,'D_location':data.D_location } } 
