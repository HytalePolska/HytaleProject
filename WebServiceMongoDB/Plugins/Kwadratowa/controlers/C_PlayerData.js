...
var Model = require("../models/PlayerData");


function Conditions(data) { return { 'PlayerID': data.PlayerID,'PD_Deaths': data.PD_Deaths,'PD_lifes': data.PD_lifes,'PD_life': data.PlayerID,'PD_IsDeath': data.PD_IsDeath,'PD_UnbanDate': data.PD_UnbanDate } };
function SetData(data) { return {  'PD_Deaths': data.PD_Deaths,'PD_lifes': data.PD_lifes,'PD_life': data.PlayerID,'PD_IsDeath': data.PD_IsDeath,'PD_UnbanDate': data.PD_UnbanDate  } }
var Controller = {};
